...
plt.plot(data['x'], data['VAEGAN'], color="#D41159", label='$\\beta$-VAEGAN$_1$', lw=0.8)
plt.plot(data['x'], data['VAEGANplus'], color="#D41159", ls='dashed', label='$\\beta$-VAEGAN$_2$', lw=0.8)
